...
# t.session
# t1 col 3
t1Columna3=$(awk '{print $3}' ../Trazas/"$1" | head -n 1)
...
awk -v tMin="$tMinimo" -v t1col3="$t1Columna3" '{if($1 == "D") {print (($3-t1col3)/8000), ($2-$3-(tMin))/8000;}}' ../Trazas/"$1" | sed 's/\ /,/g' 



# Por ultimo para guardarlo en un archivo al ejecutar el script lo redireccionamos de la siguiente manera
# >> Datos.csv
